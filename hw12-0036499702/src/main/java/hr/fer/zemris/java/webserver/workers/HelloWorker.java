...
/**
 * Implementation of {@link IWebWorker} that takes one argument,
 * name, and determines it's length.
 * @author Alex
 *
 */
public class HelloWorker implements IWebWorker {
	...
	public void processRequest(RequestContext context) throws Exception {
		...
		try {
			...
			System.err.println("An error occured during execution of HelloWorker!");
		}
